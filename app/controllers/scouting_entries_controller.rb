class ScoutingEntriesController < ApplicationController
  ...
  private
    ...
    def scouting_entry_params
      params.require(:scouting_entry).permit(:team_stat_id, :member_id, :extra_note, :drive_motors, :drive_motor_type, :drive_wheels, :drive_wheel_type, :drive_configuration, :drive_clearance, :shooter_type, :shooter_motors, :shooter_rpm, :intake_type, :intake_motors, :intake_motor_type, :intake_flip_capacity,
