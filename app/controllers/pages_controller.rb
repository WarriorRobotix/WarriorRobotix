class PagesController < ApplicationController
  skip_before_action :authenticate_admin!, only: [:home, :contact, :contact_message, :vex, :skills, :other_competitions, :photos, :teams, :about_us, :my_attendance, :member_contract]
